...
if __name__ == "__main__":
    # print(yallamotor_parser('https://uae.yallamotor.com/used-cars/mg/zs/2023/used-mg-zs-2023-dubai-1601803'))
    # print(yallamotor_parser('https://uae.yallamotor.com/used-cars/bmw/x6/2022/used-bmw-x6-2022-dubai-1603339'))
    print(yallamotor_parser('https://uae.yallamotor.com/used-cars/nissan/xterra/2023/used-nissan-xterra-2023-dubai-1605649'))